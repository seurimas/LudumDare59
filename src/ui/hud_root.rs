...
use crate::GameState;
use crate::ui::keyboard::{spawn_futhark_keyboard, spawn_zoomed_futhark_keyboard};
...
pub fn configure_hud_root(app: &mut App) {
    app.add_systems(
        ...
        (spawn_futhark_keyboard, spawn_zoomed_futhark_keyboard).after(spawn_battle_hud_root),
    );
